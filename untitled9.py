...
Original file is located at
    https://colab.research.google.com/drive/1C2kuEyp-BGc24pxAfzNTkC4nxnvxMPLo
"""
...
# --- UI Layout ---
st.set_page_config(page_title="AI LinkedIn Post Generator", page_icon="🔗", layout="centered")

# --- Header ---
st.image("https://i.imgur.com/g0QuO6B.png", width=100)
st.title("🔗 AI News Assistant for LinkedIn")
...
if st.button("Generate LinkedIn Post", type="primary"):
    if topic:
        with st.spinner("🤖 Searching the web and crafting your post..."):
            ...
            if linkedin_post:
                ...
                if citations:
                    with st.expander("📰 View News Sources Used by the AI"):
